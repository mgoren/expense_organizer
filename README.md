...
Train System is a website that uses a database and Sinatra to allow users to view categorys, lines, and connections between them. Administrators can add, delete, and modify categorys, lines, and connections.
...
train_system=# CREATE TABLE categorys (id serial PRIMARY KEY, name varchar);
train_system=# CREATE TABLE stops (id serial PRIMARY KEY, line_id int, category_id int);
